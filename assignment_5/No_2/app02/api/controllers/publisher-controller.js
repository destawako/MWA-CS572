...
module.exports.publisherGetOne = function(req,res){
    ...
    Game.findById(gameId).select("publisher").exec(function(err,game){
        ...
        else if((game.publisher == null) || game.publisher == ""){                        // ("Result Checking ")
        console.log("It does not have a publisher  ");
        response.status =404;
        response.message = {"message":"Game does not have a publisher"};
        }
        else{
